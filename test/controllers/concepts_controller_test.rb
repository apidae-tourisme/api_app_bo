...
class ConceptsControllerTest < ActionController::TestCase
  ...
  test "should create concept" do
    assert_difference('Concept.count') do
      post :create, concept: { created_at: @concept.created_at, description: @concept.description, name: @concept.name, thumbnail: @concept.thumbnail, updated_at: @concept.updated_at }
    end
  ...
  test "should update concept" do
    patch :update, id: @concept, concept: { created_at: @concept.created_at, description: @concept.description, name: @concept.name, thumbnail: @concept.thumbnail, updated_at: @concept.updated_at }
    assert_redirected_to concept_path(assigns(:concept))
  end
