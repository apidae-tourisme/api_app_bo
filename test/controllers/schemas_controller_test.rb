...
class SchemasControllerTest < ActionController::TestCase
  ...
  test "should create schema" do
    assert_difference('Schema.count') do
      post :create, schema: { created_at: @schema.created_at, description: @schema.description, name: @schema.name, thumbnail: @schema.thumbnail, updated_at: @schema.updated_at }
    end
  ...
  test "should update schema" do
    patch :update, id: @schema, schema: { created_at: @schema.created_at, description: @schema.description, name: @schema.name, thumbnail: @schema.thumbnail, updated_at: @schema.updated_at }
    assert_redirected_to schema_path(assigns(:schema))
  end
