...
class CompetencesControllerTest < ActionController::TestCase
  ...
  test "should create competence" do
    assert_difference('Competence.count') do
      post :create, competence: { created_at: @competence.created_at, description: @competence.description, name: @competence.name, thumbnail: @competence.thumbnail, updated_at: @competence.updated_at }
    end
  ...
  test "should update competence" do
    patch :update, id: @competence, competence: { created_at: @competence.created_at, description: @competence.description, name: @competence.name, thumbnail: @competence.thumbnail, updated_at: @competence.updated_at }
    assert_redirected_to competence_path(assigns(:competence))
  end
